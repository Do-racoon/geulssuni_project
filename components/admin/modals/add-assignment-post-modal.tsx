...
interface AddAssignmentPostModalProps {
  onClose: () => void
}

export default function AddAssignmentPostModal({ onClose }: AddAssignmentPostModalProps) {
  const [title, setTitle] = useState("")
  const [description, setDescription] = useState("")
  const [richDescription, setRichDescription] = useState("")
  const [classLevel, setClassLevel] = useState("intermediate")
